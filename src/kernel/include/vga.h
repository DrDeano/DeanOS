/**
 *  \file vga.h
 *  \brief A very simple vga driver that takes a forground and background colour and character to
...
/**
 *  /enum vga_colour The set of colours that vga supports and can display for the forground and background
 */
enum vga_colour {
	VGA_COLOUR_BLACK			= 0,
	VGA_COLOUR_BLUE				= 1,
...
/**
 *  \brief Take the forground and background colour and return both combinded to be used of the vga
 *  display
 *  
 *  \param [in] fg The forground colour
 *  \param [in] bg The background colour
 *  \return Both combinded into the 1 byte for the colour to be displayed
 *  
 *  \details Takes 2 4 bit values that represent the forground and background colour of the text
...
/**
 *  \brief Create a vga entry from the character, forground and background colour
 *  
 *  \param [in] uc The character
 *  \param [in] colour The forground and background clour
 *  \return The vga entry
 *  
 *  \details Create the 2 bytes entry that the vga used to display a character with a forground and
 *  background colour
 */
