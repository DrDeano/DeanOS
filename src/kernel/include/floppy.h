...
enum floppy_registers {
	...
	FLOPPY_MAIN_STATUS_REGISTER             = 0x03F4,	/**< Read only. Contains the current status information for the floppy drive controller. See \ref floppy_main_status_register for list of options. */	// Read-only
