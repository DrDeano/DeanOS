...
Sectors_in_filesystem  dw 2880           ; Bytes 19-20 - Total number of sectors in the filesystem (usually 2880)
Media_descriptor_type  db 0xf0           ; Bytes 21    - Media descripter: 3.5" floppy 1440KB
...
Total_sectors          dd 0              ; Bytes 32-35 - Total number of sectors in filesystem
...
Filesystem_type        db "FAT12   "     ; Bytes 54-61 - Filesystem tpye (FAT12), 8 characters
