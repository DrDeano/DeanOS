...
/**
 *  \brief A upper case mask for checking if the character is a upper case letter.
 */
#define UPPER_CHAR			0x01

/**
 *  \brief A lower case mask for checking if the character is a lower case letter.
 */
#define LOWER_CHAR			0x02

/**
 *  \brief A digit case mask for checking if the character is a digit.
 */
#define DIGIT_CHAR			0x04

/**
 *  \brief A control character mask for checking if the character is a control character.
 */
#define CONTROL_CHAR		0x08

/**
 *  \brief A punctuation mask for checking if the character is a punctuation letter.
 */
#define PUNCTUATION_CHAR	0x10

/**
 *  \brief A white space mask for checking if the character is a white space like space, tab,
 *  return carriage...
 */
#define WHITE_SPACE_CHAR	0x20

/**
 *  \brief A hex digit mask for checking if the character is a hex digit.
 */
#define HEX_DIGIT_CHAR		0x40

/**
 *  \brief The extended ASCII characters mask for checking if the character is a extended ASCII
 *  characters. Used for checking if is printable, as the extended range aren't in the above
 *  categories but can be printed.
 */
 ...
 */
#define isalnum(c)	(characters[(unsigned char) (c)] & (UPPER_CHAR | LOWER_CHAR | DIGIT_CHAR))
 ...
 */
#define isalpha(c)	(characters[(unsigned char) (c)] & (UPPER_CHAR | LOWER_CHAR))
 ...
 *  \return Non zero if true, else returns 0 for false.
 */
#define iscntrl(c)	(characters[(unsigned char) (c)] & (CONTROL_CHAR))
 ...
 *  \return Non zero if true, else returns 0 for false.
 */
#define isdigit(c)	(characters[(unsigned char) (c)] & (DIGIT_CHAR))
 ...
 *  \return Non zero if true, else returns 0 for false.
 */
#define isgraph(c)	(characters[(unsigned char) (c)] & (PUNCTUATION_CHAR | UPPER_CHAR | LOWER_CHAR | DIGIT_CHAR))
 ...
 *  \return Non zero if true, else returns 0 for false.
 */
#define islower(c)	(characters[(unsigned char) (c)] & (LOWER_CHAR))
 ...
 *  \return Non zero if true, else returns 0 for false.
 */
#define isprint(c)	(characters[(unsigned char) (c)] & (PUNCTUATION_CHAR | UPPER_CHAR | LOWER_CHAR | DIGIT_CHAR | WHITE_SPACE_CHAR | EXTENDED_CHAR))
 ...
 *  \return Non zero if true, else returns 0 for false.
 */
#define ispunct(c)	(characters[(unsigned char) (c)] & (PUNCTUATION_CHAR))
 ...
 *  \return Non zero if true, else returns 0 for false.
 */
#define isspace(c)	(characters[(unsigned char) (c)] & (WHITE_SPACE_CHAR))
 ...
 *  \return Non zero if true, else returns 0 for false.
 */
#define isupper(c)	(characters[(unsigned char) (c)] & (UPPER_CHAR))
 ...
 *  \return Non zero if true, else returns 0 for false.
 */
#define isxdigit(c)	(characters[(unsigned char) (c)] & (DIGIT_CHAR | HEX_DIGIT_CHAR))
